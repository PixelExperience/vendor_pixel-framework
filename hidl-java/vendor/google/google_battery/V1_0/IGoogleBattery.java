...
public interface IGoogleBattery extends android.hidl.base.V1_0.IBase {
    /**
     * Fully-qualified interface name for this interface.
     */
    public static final String kInterfaceName = "vendor.google.google_battery@1.0::IGoogleBattery";
    ...
    public static IGoogleBattery getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGoogleBattery.asInterface(android.os.HwBinder.getService("vendor.google.google_battery@1.0::IGoogleBattery", serviceName, retry));
    }
    ...
    public static IGoogleBattery getService(String serviceName) throws android.os.RemoteException {
        return IGoogleBattery.asInterface(android.os.HwBinder.getService("vendor.google.google_battery@1.0::IGoogleBattery", serviceName));
    }
    ...
    void getChargingStageAndDeadline(getChargingStageAndDeadlineCallback _hidl_cb)
        throws android.os.RemoteException;
    byte setChargingDeadline(int deadline)
        throws android.os.RemoteException;
    /*
    ...
    public static final class Proxy implements IGoogleBattery {
        ...
        public void getChargingStageAndDeadline(getChargingStageAndDeadlineCallback _hidl_cb)
            ...
            try {
                mRemote.transact(1 /* getChargingStageAndDeadline */, _hidl_request, _hidl_reply, 0 /* flags */);
        ...
        @Override
        public byte setChargingDeadline(int deadline)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.google.google_battery.V1_0.IGoogleBattery.kInterfaceName);
            _hidl_request.writeInt32(deadline);

            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* setChargingDeadline */, _hidl_request, _hidl_reply, 0 /* flags */);
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGoogleBattery {
        ...
        public final String interfaceDescriptor() {
            return vendor.google.google_battery.V1_0.IGoogleBattery.kInterfaceName;
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
                throws android.os.RemoteException {
            switch (_hidl_code) {
                case 1 /* getChargingStageAndDeadline */:
                {
                ...
                case 2 /* setChargingDeadline */:
                {
                    _hidl_request.enforceInterface(vendor.google.google_battery.V1_0.IGoogleBattery.kInterfaceName);

                    int deadline = _hidl_request.readInt32();
                    byte _hidl_out_result = setChargingDeadline(deadline);
                    _hidl_reply.writeStatus(android.os.HwParcel.STATUS_SUCCESS);
