...
public interface IGoogleBattery extends vendor.google.google_battery.V1_0.IGoogleBattery {
     ...
     */
    public static final String kInterfaceName = "vendor.google.google_battery@1.1::IGoogleBattery";
    ...
    public static IGoogleBattery getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IGoogleBattery.asInterface(android.os.HwBinder.getService("vendor.google.google_battery@1.1::IGoogleBattery", serviceName, retry));
    }
    ...
    public static IGoogleBattery getService(String serviceName) throws android.os.RemoteException {
        return IGoogleBattery.asInterface(android.os.HwBinder.getService("vendor.google.google_battery@1.1::IGoogleBattery", serviceName));
    }
     ...
     * the property is not overridden from the system default.
     *
     * @param feature identifies the battery feature
     * @param property identifies the battery feature property
     * @param value is the property to be set as int32_t.
     */
    byte setProperty(int feature, int property, int value)
    ...
    /**
     * Gets the battery feature property.
     *
     * @param feature identifies the battery feature
     * @param property identifies the battery feature property
     *
     * @return the property as an int32_t
     */
    void getProperty(int feature, int property, getPropertyCallback _hidl_cb)
        throws android.os.RemoteException;
    /*
    ...
    public static abstract class Stub extends android.os.HwBinder implements IGoogleBattery {
        ...
        public final String interfaceDescriptor() {
            return vendor.google.google_battery.V1_1.IGoogleBattery.kInterfaceName;
